...
import tn.Spring.config.MyConstants;
...
public class EmailRestController {
    ...
    public String sendSimpleEmail() {
        ...
        message.setSubject("Mr Skander");
        message.setText("This is My API Mailer Welcome To my Project");

        // Send Message!
        this.emailSender.send(message);

        return "Email Sent to Mr Skander!";
    }
